...
func _ready() -> void:
	...
	TweenUtils.tweenX(sprite,-755.0,0.3,TweenUtils.Ease.OutCirc)
	...
	BlastStart()
	TweenUtils.tweenX(sprite,-1400.0,0.8,TweenUtils.Ease.InSine)
	TweenUtils.tweenAlpha(self,0,0.8,TweenUtils.Ease.linear)
